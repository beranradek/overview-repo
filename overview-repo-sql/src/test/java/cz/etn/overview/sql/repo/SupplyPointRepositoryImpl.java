 ...
 * @author Radek Beran
 */
public class SupplyPointRepositoryImpl extends SqlRepository<SupplyPoint, Integer, SupplyPointFilter> implements SupplyPointRepository {

	public SupplyPointRepositoryImpl(DataSource dataSource) {
		super(dataSource, SupplyPointMapper.getInstance());
	}
}
